...
import { Clock, Trash2, ChefHat, BookOpen } from "lucide-react";
    ...
    <div className="px-4 py-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          {items.length === 0 ? "Nessuna ricetta salvata" : `${items.length} ricette salvate`}
        </p>
      </div>
            ...
            <div key={item.id} className="food-card p-4">
              <div className="flex items-start gap-3">
                ...
                <button
                  ...
                  className="p-2 text-muted-foreground hover:text-destructive hover:bg-destructive/5 rounded-xl transition-colors flex-shrink-0"
                >
